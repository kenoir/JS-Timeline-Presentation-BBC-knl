(function() {
    ...
    JUnitXmlReporter.prototype = {
        ...
        reportRunnerResults: function(runner) {
            ...
            var $wrapBlock = $('<div id="JUnitReporter"></div>');
            ...
            for (var i = 0; i < suites.length; i++) {
                ...
                var $output = this.generateScriptBlock(this.savePath + fileName, output);
                $wrapBlock.append($output);
            }

            // Wrap the output in a div and append it to the dom
            $('body').append($wrapBlock);
        ...
        generateScriptBlock: function(filename, text) {
          var $scriptBlock = $('<script type="application/xml" data-filename='+filename+'>' + text + '</script>');
          //window.junitReports.push({'filename':filename,'contents':text});
          return $scriptBlock;
        },
